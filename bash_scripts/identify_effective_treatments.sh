...
sbatch run_highest_mock_proba.sh ../data/HRCE-1/embeddings_and_metadata.csv HRCE-1/ $1
sbatch run_highest_mock_proba.sh ../data/HRCE-2/embeddings_and_metadata.csv HRCE-2/ $2
sbatch run_highest_mock_proba.sh ../data/VERO-1/embeddings_and_metadata.csv VERO-1/ $3
sbatch run_highest_mock_proba.sh ../data/VERO-2/embeddings_and_metadata.csv VERO-2/ $4